...
filename = 'assign8TestNov282022.csv'
main_dir = os.getcwd()
data_dir = os.path.join(main_dir,'data')
if not os.path.exists(data_dir):
    os.makedirs(data_dir)
...
## Read JSON exercises
Using csv file saving method (Dr. Mathewson said if json is causing trouble, use csv to complete the following exercises) 
